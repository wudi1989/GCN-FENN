        ...
        for dim in [16,8,32]:
            for _ in range(10):
                ...
                for epoch in range(args.epochs):
                    ...
                    features = torch.FloatTensor(matrix_array[20])
                    ...
                    if tp != 0 and fn != 0:
                        ...
                        if tp+fn>414*0.8:
                            ...
                            if 2 * (tp / (tp + 266 - fn)) * (tp / 148) / (tp / 148 + tp / (tp + 266 - fn))>mx[0][3]:
                                mx[0][1]=tp / (tp + 266 - fn)
                                mx[0][2]=tp/148
                                mx[0][3]=2 * (tp / (tp + 266 - fn)) * (tp / 148) / (tp / 148 + tp / (tp + 266 - fn))
                ...
                print(f"time_step:2021,{mx[0][0]},{mx[0][1]},{mx[0][2]},{mx[0][3]},{mx[0][4]},{mx[0][5]}")
